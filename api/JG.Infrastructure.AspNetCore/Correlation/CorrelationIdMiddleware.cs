...
namespace JG.Infrastructure.AspNetCore.Correlation
{
    /// <summary>
    ...
    public class CorrelationIdMiddleware
    {
        ...
        public async Task Invoke(HttpContext context, ICorrelationContextFactory correlationContextFactory)
        {
            ...
            if (_options.IncludeInResponse)
                ...
                context.Response.OnStarting(() =>
                {
                    ...
                    if (!context.Response.Headers.ContainsKey(HttpHeaders.X_REQUEST_ID))
                        context.Response.Headers.Add(HttpHeaders.X_REQUEST_ID, context.TraceIdentifier);
        ...
        private StringValues SetCorrelationId(HttpContext context)
        {
            var correlationIdFoundInRequestHeader =
                context.Request.Headers.TryGetValue(_options.Header, out var correlationId);
        ...
        {
            return _options.UseGuidForCorrelationId || string.IsNullOrEmpty(traceIdentifier)
